...
closeNav();
function closeNav() {
    let width = $('.sideNavBarContent').outerWidth();
...
$('.sideNavBar .open-close').on('click', function () {
...
function showSearchInputs() {
    searchContainer.innerHTML = `<div class="row py-5">
      <div class="col-md-6">
        <input
          type="text"
          class="form-control bg-info mb-3 mb-md-0"
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-4">
              ...
              <div id="emailAlert" class="alert alert-danger mt-2 d-none">
                Email not valid, ex: mohamed@gmail.com
              </div>
            </div>
            <div class="col-md-6 mb-4">
              <input
